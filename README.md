...
抽出できているショップは合計 **32,365件**(買取31,217件・販売1,148件。
50万円以上のみで**164件**、買取112件・販売52件)。
...
- 販売(sell)で実データ抽出できているショップ(通販サイト、件数順):
  - トレカプラザ55 720件(0件) — 新規発見。タイプ別ページ12種を巡回
  - カードラッシュ 84件(20件)
  - カードラボ 48件(0件)
  - 福福トレカコレクション 78件(0件) — 新規発見。既存の福福トレカとは
    別ドメイン。ページネーション全7ページを巡回
  - トレカキャンプ 65件(0件)
  - 福福トレカ 64件(0件)
